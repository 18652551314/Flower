package com.example.android.flower;
...
public class Garden { //创建一个随机的花朵
    ...
    static class Options {
        ...
        public static int maxPetalCount = 15; //用于控制产生延长线倍数范围
        public static float minPetalStretch = 2f;
        public static float maxPetalStretch = 3.5f; //用于控制产生随机增长因子范围,增长因子决定花瓣绽放速度
        public static float minGrowFactor = 1f;
        public static float maxGrowFactor = 1.1f; //用于控制产生花朵半径随机数范围
        public static int minBloomRadius = 8;
        public static int maxBloomRadius = 10; //用于产生随机颜色
        ...
        public static int maxBlueColor = 128; //花瓣的透明度
